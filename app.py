...
def sign_up():
    ...
    db.users.insert_one({'username': username_receive, 'password': password_hash})
...
def posting():
    ...
    try:
        ...
        doc = {
            ...
            'profile_name': user_info.get('username'),
...
def update_like():
    ...
    try:
        ...
        return jsonify({'result': 'success', 'msg': 'Like updated', 'count': count})
